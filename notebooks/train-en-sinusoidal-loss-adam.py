...
# train
model.compile(loss=sinusoidal_loss, optimizer=Adam(learning_rate=0.01), metrics=[angular_loss_mae])
...
cp = ModelCheckpoint("/data/subhadip/weights/model-en-sin-adam-loss.h5", save_weights_only=False, 
