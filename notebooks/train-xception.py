...
#Define conv base
conv_base = Xception(weights="imagenet", include_top=False, input_shape=(IMAGE_SIZE, IMAGE_SIZE, 3))
...
train_gen = RotGenerator("/data/subhadip/data/train2017_Resize/", 16, IMAGE_SIZE)
cp = ModelCheckpoint("/data/subhadip/weights/model-xc-ang-loss.h5", save_weights_only=False, 
