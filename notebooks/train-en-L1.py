...
# train
model.compile(loss="mae", optimizer=Adadelta(learning_rate=0.1), metrics=[angular_loss_mae])
...
cp = ModelCheckpoint("/data/subhadip/weights/model-en-l1-loss.h5", save_weights_only=False, 
