...
from loss import angular_loss_mae, sinusoidal_loss, circular_loss
import glob
import os
import numpy as np
import cv2
...
# train
model.compile(loss=circular_loss, optimizer=Adam(learning_rate=0.1), metrics=[angular_loss_mae])
...
cp = ModelCheckpoint("/data/subhadip/weights/model-en-cir-adam-loss.h5", save_weights_only=False, 
